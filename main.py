...
def main():
    ...
    db_name = "courses_db"
    create_database("courses_db")
    create_tables("courses_db")
    insert_data("courses_db")
    ...
    while True:
        ...
        if user_input == "1":
            ...
            print(
                "Список всех вакансий с указанием  компании, вакансии и зарплаты и ссылки на вакансию:"
            )
            ...
            keyword = input(
                "Введите слово, по которому хотите отфильтровать вакансии: \n"
            ).lower()
